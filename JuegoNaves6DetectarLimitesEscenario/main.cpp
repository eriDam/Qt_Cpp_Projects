...
class NAVE{
    ...
    int x, y;
    //Creamos otra variable para la clase
    int corazones;
    ...
    */
    ...
    if(kbhit()){
        ...
        */
        ...
        if(tecla == 'l' && x+6 < 77) x++;//Si tecla j pulsada,  posicion AUMENTA(DERECHA)
        ...
        if(tecla == DERECHA   && x+6 < 77) x++;//Si Flecha DERECHA pulsada, y x+6(por que tiene varios caracteres) es menor q 77 que es el limite de la dcha  posicion AUMENTA(DERECHA)
