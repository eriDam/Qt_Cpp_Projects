...
{
public:
	int *r;	/* SOAP 1.2 RPC return element (when namespace qualified) */	/* optional element of type xsd:int */
public:
	int soap_type() const { return 9; } /* = unique type id SOAP_TYPE_op1Response */
};
#endif
...
public:
	int soap_type() const { return 10; } /* = unique type id SOAP_TYPE_op1 */
};
#endif
...
SOAP_FMAC5 int SOAP_FMAC6 op1(struct soap*, int a, int b, int *r);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve_op1(struct soap*);
